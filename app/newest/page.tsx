                  ...
                  <div className="px-3 sm:px-5 pb-3 sm:pb-5">
                    <div className="flex items-center">
                      ...
                      <div className="flex-shrink-0 mr-4 sm:mr-6">
                        <div className="w-8 h-8 sm:w-12 sm:h-12 bg-green-100 rounded-full flex items-center justify-center border-2 border-green-200">
                          <div className="px-1 sm:px-2 py-0.5 sm:py-1 bg-green-500 text-white text-xs font-medium rounded">
                            NEW
                          </div>
                        </div>
                      </div>
